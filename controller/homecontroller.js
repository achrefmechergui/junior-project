...
exports.getfoodcontroller = (req, res) => {
 ...
 exports.addfoodcontroller = (req,res)=>{
    homemodel.addfoodmodel(req.body.img,req.body.name,req.body.description).then((result)=>{
        res.send(result)
    })
...
exports.updatefoodcontroller = (req,res)=>{
    homemodel.updatefoodmodel(req.body.img,req.body.name,req.body.description,req.params.id).then((result)=>{
        res.send(result)
    })
}
