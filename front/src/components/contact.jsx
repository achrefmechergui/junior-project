...
const Contact = () => {
    return (
        <div  >
           <div class="contact3 py-5 contactmargin">
  <div >
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="contact-box ml-3">
            ...
            <form class="mt-4">
              <div class="row">
                ...
                <div class="col-lg-12">
                  <button type="submit" class="btn btn-primary mt-3 text-white border-0 px-3 py-2"><span> SUBMIT</span></button>
                </div>
              </div>
            </form>
          </div>
